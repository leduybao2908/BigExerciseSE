...
public class ForgotPasswordScreen extends JFrame {
    ...
    private JTextField enterGmailtf;
    private JPasswordField EnterNewPasswordtf;
    ...
    public ForgotPasswordScreen() {
        ...
        final JButton GetOTPButton = new JButton();
        ...
        EnterNewPasswordtf = new JPasswordField();
