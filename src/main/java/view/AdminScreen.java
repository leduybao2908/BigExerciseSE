...
//	ArrayList<Product> result = new ArrayList<Product>();
	...
	public AdminScreen() {
		...
		JButton btnSearchSell = new JButton();
		...
		JButton ButtonAddManage = new JButton();
	...
	//               updateTextTongTienManage(newTotal);
		...
		JButton ButtonUpdateManage = new JButton();
	...
	//                updateTextTongTienManage(newtotal); 
		...
		JButton ButtonXoaManage =new JButton();
		...
		JButton btnFindMangeProduct =new JButton();
 	...
 	//	               updateTextTongTienManage(newTotal);
		...
		JButton btnDeleteEmployee = new JButton();
		...
		JButton btnUpdateInformation = new JButton();
		...
		JButton btnSearchEmployee = new JButton();
