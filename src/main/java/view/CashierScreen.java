...
import supportview.ClientFrame;
...
public class CashierScreen extends JFrame {
	...
	public CashierScreen(final String userName) {
	        // ...
		...
		TextTotalCart = new JTextField(60);
		...
		textFieldCostSell = new JTextField(60);
		...
		textFieldCountNeedBuy = new JTextField(60);
		...
		textFieldCountSellWarehouse = new JTextField(60);
		...
		textFieldNameItemSell = new JTextField(60);
		...
		textFieldIDItemSell = new JTextField(60);
		...
		textFieldCateID = new JTextField(60);
		...
		JButton ButtonAddToCart = new JButton();
		...
		JButton btnDeleteItemCart = new JButton();
		...
		final JComboBox comboBoxSell = new JComboBox();
...
timer.start(); // Bắt đầu đếm thời gian khi khởi động ứng dụng
	...
	public void SelectComboBoxSellTable(int CateID) {
		...
		tableModel = (DefaultTableModel) TableTotalSalesList.getModel();
		    ArrayList<Product> items = new CashierItemDAO().selectCategory(CateID);
		    tableModel.getDataVector().removeAllElements();
		    tableModel.setRowCount(0); // Clear existing data
